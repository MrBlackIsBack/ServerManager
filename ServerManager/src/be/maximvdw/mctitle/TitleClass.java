...
public class TitleClass {
	 ...
	 *            Subtitle text
	 */
	public TitleClass(String title, String subtitle) {
		this.title = title;
	 ...
	 *            Title
	 */
	public TitleClass(TitleClass title) {
		// Copy title
	 ...
	 *            Fade out time
	 */
	public TitleClass(String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
	...
	public void send(Player player) {
		if (packetTitle != null) {
			...
			try {
				...
				Object packet = packetTitle.getConstructor(packetActions, chatBaseComponent, Integer.TYPE, Integer.TYPE, Integer.TYPE).newInstance(
						actions[2], null, fadeInTime * (ticks ? 1 : 20), stayTime * (ticks ? 1 : 20), fadeOutTime * (ticks ? 1 : 20));
				// Send if set
