...
public class DynamicMOTD implements Listener {
	...
	public DynamicMOTD(ServerManager main) {
		this.main = main;
	}
	...
	public void onPing(ServerListPingEvent e) {
		...
		String trans = ChatColor.translateAlternateColorCodes('&', main.dynamicMotd.get(new Random().nextInt(main.dynamicMotd.size())));
